...
router.post('/add-blog',isAuth,blogValidate,blogController.postMyBlog);
router.get('/edit-blog/:blogId',isAuth, blogController.getEditPage);
router.post('/edit-blog/:blogId',isAuth,blogValidate,blogController.postEditPage);
router.delete('/delete-blog/:blogId',isAuth,blogController.deleteBlog)
